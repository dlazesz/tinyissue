...
#### Rendering the contents of a section:
	...
	<head>
		<?php echo Section::yieldd('scripts'); ?>
	</head>
...
Notice the "content" section being yieldded. We need to fill this section with some text, so let's make another view that uses this layout:
